...
//  console.log(event.target.nodeName)--показує по якому саме місці я клікнув 
  // console.log(event.currentTarget.nodeName) --показує на якому місці поставлено обробник подіїї
}
